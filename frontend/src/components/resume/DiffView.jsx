...
export function DiffView({ resumeId, versions }) {
  ...
  const net = data ? data.summary.addedChars - data.summary.removedChars : 0;
          ...
          >
            ...
            <div className="relative flex items-end gap-8 flex-wrap">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-1.5 mt-1.5">
                  <GradientNumber
                    value={`−${data.summary.removedChars}`}
                    size={40}
                    palette="danger"
                  />
                  <span className="text-[11px] text-[var(--ink-muted)]">
              ...
              <div className="ml-auto text-right">
                ...
                <div className="mt-1.5 inline-flex items-center gap-2 text-[12px] font-semibold text-[var(--ink)] tabular-nums">
                  <span>{fromLabel}</span>
